...
?>
        <h1>Indica los datos que deseas cambiar:</h1>
        ...
        <form action="procesamiento_datos/update_datos.php" method="post">
            <label for="nick">Nick de Usuario:</label>
            <input type="text" name="nick" id="nick" pattern="[a-zA-Z0-9!@#$%^&*(),.?:{}|<>]+" >
            <br>
           ...
           <h2> <?=  $_SESSION['nick_error']; ?></h2>
            ...
            <input type="text" name="nombre" id="nombre" pattern="[a-zA-ZáéíóúÁÉÍÓÚñÑ\s]+" r>
            <br>
            <label for="apellidos">Apellidos:</label>
            <input type="text" name="apellidos" id="apellidos" pattern="[a-zA-ZáéíóúÁÉÍÓÚñÑ\s]+" >
            <br>
           ...
           <h2> <?=  $_SESSION['email_error']; ?></h2>
            ...
            <input type="text" name="provincia" id="provincia" pattern="[a-zA-ZáéíóúÁÉÍÓÚñÑ\s]+" >
            <br>
            <label for="municipio">Municipio:</label>
            <input type="text" name="municipio" id="municipio" pattern="[a-zA-ZáéíóúÁÉÍÓÚñÑ\s]+" >
            <br>
            <label for="codigo_postal">Código Postal:</label>
            <input type="text" name="codigo_postal" id="codigo_postal" pattern="[a-zA-ZáéíóúÁÉÍÓÚñÑ\-s 0-9]+" >
            <br>
